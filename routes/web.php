...
Route::get('/create-password/{token}', [FrontendPageController::class, 'create_password'])->name('create-password');
Route::post('/update-password', [FrontendPageController::class, 'update_password'])->name('update-password');
